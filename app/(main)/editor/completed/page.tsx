/**
 * Completed Reviews Page - Show all user completed reviews (no limit)
 * 
...
export default async function CompletedPage() {
  ...
  // Fetch all completed reviews (no limit), ordered by updatedAt desc
  ...
  const completedTyped = await enrichReviewItems(completedRaw);
  const completed = completedTyped as unknown as EnrichedReview[];
    ...
    <div className="p-4 md:p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-[#a1a1aa] mt-1">
          {completed.length} {completed.length === 1 ? 'reseña' : 'reseñas'}
        </p>
      </div>
