...
### branch-pr
- Path: C:\Users\elect\.config\opencode\skills\branch-pr\SKILL.md
...
### chained-pr
- Path: C:\Users\elect\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\elect\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\elect\.config\opencode\skills\comment-writer\SKILL.md
...
### find-skills
- Path: C:\Users\elect\.agents\skills\find-skills\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### frontend-design
- Path: C:\Users\elect\.agents\skills\frontend-design\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: C:\Users\elect\.config\opencode\skills\go-testing\SKILL.md
- Trigger: Trigger: Go tests, go test coverage, Bubbletea teatest, golden files. Apply focused Go testing patterns.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### issue-creation
- Path: C:\Users\elect\.config\opencode\skills\issue-creation\SKILL.md
- Trigger: Create Gentle AI issues with issue-first checks. Trigger: creating GitHub issues, bug reports, or feature requests.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### judgment-day
- Path: C:\Users\elect\.config\opencode\skills\judgment-day\SKILL.md
...
### skill-creator
- Path: C:\Users\elect\.config\opencode\skills\skill-creator\SKILL.md
...
### work-unit-commits
- Path: C:\Users\elect\.config\opencode\skills\work-unit-commits\SKILL.md
